...
public class User implements Serializable {
	...
	private static final long serialVersionUID = -8660876022243042363L;
	...
	public User(Integer id, String username, String password, String email, String phone, String createdUser,
	...
	public String toString() {
		return "User [id=" + id + ", username=" + username + ", password=" + password + ", email=" + email + ", phone="
				+ phone + ", createdUser=" + createdUser + ", createdTime=" + createdTime + ", modifiedUser="
